...
I will now respond to suggsted changes and other constructive criticisms.
...
- Agreed, but I would prefer to keep the README as a whole piece, so I think instead I will just link to the experimental vignette as in the README. This has been logged in [issue 39]() and fixed in commit 

> Link to the vignettes from the README.

- Agreed, this has been address in commit ..., issue ...
...
- Agreed, this has been changed in issue ....
...
- Interesting, it should be showing up as black, as this is what the [code and README reflect]() (well, grey50). Does it still happen now?
...
- Agreed, this has been done in commit ... , issue ...
...
- Agreed, this has been completed in this commit ..., issue...
