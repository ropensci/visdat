...
- I am glad you like this! It is a difficult problem that I cannot work out, re the rows/cols matching when they are out of the dimension. I'm not quite sure what to do here to make this possible, I think that this should be tackled in a future release of `visdat`.
...
- Thank you for picking up on this, I've updated the main descriotion file now
...
- refactoring repeated code into internal functions to more clearly express what
...
- For the moment I have decided to put visdat onto CRAN, with the main functions
being: 
  - vis_dat
  - vis_miss
  - vis_guess
- Then, in a subsequent release, I will add the interactive functions:
  - vis_dat_ly
  - vis_miss_ly
  - vis_guess_ly
  - vis_compare
- And also look into speed improvements for `vis_guess`
