...
- These references are provided in the yaml, and in a .bib file - hopefully these get compiled with the JOSS paper, but perhaps @arfon can chime in here.
...
- I agree that the rows should be in the order that you see the dataframes. I would also prefer for the column names to be on top of the visualisation, but I cannot seem to get the column names to present nicely here.

- The flip argument was placed there to experiment with this idea of flipping the plot - as you suggested, to have row 1 at the top. Personally, I think that now the flip argument should be removed, as I cannot now really think of any times where I would prefer the old arrangement of rows.

- I agree with you re the palette, although I'm not sure how this could work for vis_miss. But perhaps I should allow for users to insert their own pallete for this.
...
- Thank you very much for this, I have created a helper function as you suggested, and suppressed the message in that way.
...
- I've actually not heard this before, but I can certainly understand why you would want to avoid called such as if(x == TRUE) over if(x). Personally, however, I think I actually prefer to be really explicit.
