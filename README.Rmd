...
To demonstrate what visdat looks like when you have different kinds of data, we can use `visdat` to look at the dataset `typical_data`, which is from the excellent [`wakefield package`](https://github.com/trinker/wakefield).
