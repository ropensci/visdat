...
[![Travis-CI Build Status](https://travis-ci.org/tierneyn/visdat.svg?branch=master)](https://travis-ci.org/tierneyn/visdat)

<!-- Add an appVeyor badge -->
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/tierneyn/visdat?branch=master&svg=true)](https://ci.appveyor.com/project/tierneyn/visdat)
